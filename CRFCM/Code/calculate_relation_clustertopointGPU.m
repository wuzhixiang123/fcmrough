function relation_clustertopoint = calculate_relation_clustertopointGPU(lower_approx_matrix, lower_W_matrices,edges_matrix,edge_W_matrices,m,w_low,w_upper)
...
%             disp(result_vector);
    ...
    relation_clustertopoint = gather(relation_clustertopoint);
end
